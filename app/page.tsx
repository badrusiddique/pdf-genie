    ...
    <main>
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-28 pb-20 text-center overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden>
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] rounded-full" style={{ background: 'radial-gradient(ellipse, rgba(6,182,212,0.20) 0%, transparent 70%)' }} />
        ...
        <div className="flex justify-center mb-6">
          <div className="animate-float" style={{ filter: 'drop-shadow(0 0 20px rgba(6,182,212,0.5))' }}>
            <GenieLampIcon className="w-16 h-16" animated />
          </div>
        </div>

        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-8 text-xs font-medium" style={{ background: 'rgba(6,182,212,0.1)', border: '1px solid rgba(6,182,212,0.2)', color: '#22D3EE' }}>
      ...
      <section id="tools" className="max-w-7xl mx-auto px-4 sm:px-6 pb-24">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#06B6D4' }}>31 TOOLS</span>
      ...
      {/* Trust strip */}
      <section className="py-12 mx-4 sm:mx-6 mb-8 rounded-2xl" style={{ background: 'rgba(6,182,212,0.08)', border: '1px solid rgba(6,182,212,0.15)' }}>
